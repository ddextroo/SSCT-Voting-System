...
public class PresidentActivity extends  AppCompatActivity  { 
	...
	private HashMap<String, Object> nap1 = new HashMap<>();
	...
	private DatabaseReference pres = _firebase.getReference("pres");
	private ChildEventListener _pres_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_pres_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
				final HashMap<String, Object> _childValue = _param1.getValue(_ind);
				pres.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						recyclerview1.setLayoutManager(new LinearLayoutManager(PresidentActivity.this));
		...
		pres.addChildEventListener(_pres_child_listener);
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			View _v = _inflater.inflate(R.layout.presidentc, null);
			...
			radiobutton1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					if (radiobutton1.isChecked()) {
						...
						pres.child(postlist.get((int)(_position))).updateChildren(map);
						radiobutton1.setChecked(false);
						radiobutton2.setChecked(true);
					}
					d.setTitle("SSCT VOTING APP");
					d.setMessage("Proceed? If you click proceed. Do not exit the app or do not press back until you done voting.");
					d.setPositiveButton("Proceed", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface _dialog, int _which) {
							...
							nap1.put("done", "true");
							pres.child(postlist.get((int)(_position))).updateChildren(map);
							user.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).updateChildren(nap1);
							i.setClass(getApplicationContext(), VoteActivity.class);
							startActivity(i);
							finish();
						}
					});
