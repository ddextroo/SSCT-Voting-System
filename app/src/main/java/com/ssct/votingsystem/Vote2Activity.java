...
public class Vote2Activity extends  AppCompatActivity  { 
	...
	private DatabaseReference tr = _firebase.getReference("tr");
	private ChildEventListener _tr_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_tr_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				tr.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						recyclerview1.setLayoutManager(new LinearLayoutManager(Vote2Activity.this));
		...
		tr.addChildEventListener(_tr_child_listener);
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			View _v = _inflater.inflate(R.layout.tre, null);
			...
			radiobutton1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					if (radiobutton1.isChecked()) {
						...
						tr.child(postlist.get((int)(_position))).updateChildren(map);
					...
					tr.child(postlist.get((int)(_position))).updateChildren(map);
					i.setClass(getApplicationContext(), Vote3Activity.class);
					startActivity(i);
					finish();
				}
			});
