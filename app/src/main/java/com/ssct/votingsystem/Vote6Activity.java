...
public class Vote6Activity extends  AppCompatActivity  { 
	...
	private DatabaseReference pea = _firebase.getReference("pea");
	private ChildEventListener _pea_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_pea_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
				final HashMap<String, Object> _childValue = _param1.getValue(_ind);
				pea.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						recyclerview1.setLayoutManager(new LinearLayoutManager(Vote6Activity.this));
		...
		pea.addChildEventListener(_pea_child_listener);
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			View _v = _inflater.inflate(R.layout.peace, null);
			...
			radiobutton1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					if (radiobutton1.isChecked()) {
						...
						pea.child(postlist.get((int)(_position))).updateChildren(map);
					...
					pea.child(postlist.get((int)(_position))).updateChildren(map);
					i.setClass(getApplicationContext(), Vote7Activity.class);
					startActivity(i);
					finish();
				}
			});
