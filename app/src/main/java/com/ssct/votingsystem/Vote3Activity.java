...
public class Vote3Activity extends  AppCompatActivity  { 
	...
	private DatabaseReference au = _firebase.getReference("au");
	private ChildEventListener _au_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_au_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
				final HashMap<String, Object> _childValue = _param1.getValue(_ind);
				au.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						recyclerview1.setLayoutManager(new LinearLayoutManager(Vote3Activity.this));
		...
		au.addChildEventListener(_au_child_listener);
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			View _v = _inflater.inflate(R.layout.aud, null);
			...
			radiobutton1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					if (radiobutton1.isChecked()) {
						...
						au.child(postlist.get((int)(_position))).updateChildren(map);
					...
					au.child(postlist.get((int)(_position))).updateChildren(map);
					i.setClass(getApplicationContext(), Vote4Activity.class);
					startActivity(i);
					finish();
				}
			});
