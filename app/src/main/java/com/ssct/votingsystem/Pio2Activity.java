...
public class Pio2Activity extends  AppCompatActivity  { 
	...
	private DatabaseReference pio = _firebase.getReference("pio");
	private ChildEventListener _pio_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_pio_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
				final HashMap<String, Object> _childValue = _param1.getValue(_ind);
				pio.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						recyclerview1.setLayoutManager(new LinearLayoutManager(Pio2Activity.this));
		...
		pio.addChildEventListener(_pio_child_listener);
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			View _v = _inflater.inflate(R.layout.pio_2, null);
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			textview2.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/poppinsr.ttf"), 0);
			radiobutton1.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/poppinsr.ttf"), 0);
			radiobutton2.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/poppinsr.ttf"), 0);
			...
			textview6.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/poppinsr.ttf"), 0);
			...
			if (lmap.get((int)_position).containsKey("partylist")) {
				textview1.setText(lmap.get((int)_position).get("partylist").toString());
			}
			if (lmap.get((int)_position).containsKey("name")) {
				textview2.setText(lmap.get((int)_position).get("name").toString());
			}
			if (lmap.get((int)_position).containsKey("grade")) {
				textview6.setText(lmap.get((int)_position).get("grade").toString());
			}
			if (lmap.get((int)_position).containsKey("image")) {
				Glide.with(getApplicationContext()).load(Uri.parse(lmap.get((int)_position).get("image").toString())).into(circleimageview1);
			}
			radiobutton1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					if (radiobutton1.isChecked()) {
						...
						pio.child(postlist.get((int)(_position))).updateChildren(map);
						radiobutton1.setChecked(false);
						radiobutton2.setChecked(true);
					}
					if (sp.getString("pio1", "").equals(lmap.get((int)_position).get("name").toString())) {
						FancyToast.makeText(Pio2Activity.this, "Error, the name is already selected.", FancyToast.LENGTH_LONG, FancyToast.ERROR, true).show();
						radiobutton1.setChecked(false);
						radiobutton2.setChecked(true);
					}
					else {
						...
						pio.child(postlist.get((int)(_position))).updateChildren(map);
						i.setClass(getApplicationContext(), Vote5Activity.class);
						startActivity(i);
						finish();
					}
				}
