...
public class Vote5Activity extends  AppCompatActivity  { 
	...
	private DatabaseReference bus = _firebase.getReference("bus");
	private ChildEventListener _bus_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_bus_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				bus.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						recyclerview1.setLayoutManager(new LinearLayoutManager(Vote5Activity.this));
		...
		bus.addChildEventListener(_bus_child_listener);
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			View _v = _inflater.inflate(R.layout.busi, null);
			...
			radiobutton1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					if (radiobutton1.isChecked()) {
						...
						bus.child(postlist.get((int)(_position))).updateChildren(map);
					...
					i.setClass(getApplicationContext(), Vote6Activity.class);
					startActivity(i);
					finish();
				}
			});
