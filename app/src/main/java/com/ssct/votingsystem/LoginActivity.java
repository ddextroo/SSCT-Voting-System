...
public class LoginActivity extends  AppCompatActivity  { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		signinbutton1 = (SignInButton) findViewById(R.id.signinbutton1);
	...
	private void initializeLogic() {
		...
		api = "486198163681-e42vbrfictcjkji4r8rlf19tt1cl5c20.apps.googleusercontent.com";
		GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN).requestIdToken(api).requestEmail().build();
	...
	public void _onGoogleSigninOptions_ () {
	}
		...
		mAuth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
			...
			public void onComplete(@NonNull Task<AuthResult> task) {
				if (task.isSuccessful()) {
					FancyToast.makeText(LoginActivity.this, "Success", FancyToast.LENGTH_LONG, FancyToast.SUCCESS, true).show();
					i.setClass(getApplicationContext(), HomeActivity.class);
					startActivity(i);
					finish();
				} else {
					FancyToast.makeText(LoginActivity.this, "Failed", FancyToast.LENGTH_LONG, FancyToast.ERROR, true).show();
				}
			}
		});
	}
