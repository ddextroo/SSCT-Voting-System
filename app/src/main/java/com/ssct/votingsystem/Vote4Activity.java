...
public class Vote4Activity extends  AppCompatActivity  { 
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				pio.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						recyclerview1.setLayoutManager(new LinearLayoutManager(Vote4Activity.this));
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			View _v = _inflater.inflate(R.layout.pio, null);
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			radiobutton1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					...
					pio.child(postlist.get((int)(_position))).updateChildren(map);
					sp.edit().putString("pio1", lmap.get((int)_position).get("name").toString()).commit();
					i.setClass(getApplicationContext(), Pio2Activity.class);
					startActivity(i);
					finish();
				}
			});
