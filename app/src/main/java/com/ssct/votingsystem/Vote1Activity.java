...
public class Vote1Activity extends  AppCompatActivity  { 
	...
	private DatabaseReference sec = _firebase.getReference("sec");
	private ChildEventListener _sec_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_sec_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				sec.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						recyclerview1.setLayoutManager(new LinearLayoutManager(Vote1Activity.this));
		...
		sec.addChildEventListener(_sec_child_listener);
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			View _v = _inflater.inflate(R.layout.sec, null);
			...
			radiobutton1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					if (radiobutton1.isChecked()) {
						...
						sec.child(postlist.get((int)(_position))).updateChildren(map);
					...
					sec.child(postlist.get((int)(_position))).updateChildren(map);
					i.setClass(getApplicationContext(), Vote2Activity.class);
					startActivity(i);
					finish();
				}
			});
