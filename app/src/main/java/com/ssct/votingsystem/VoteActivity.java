...
public class VoteActivity extends  AppCompatActivity  { 
	...
	private DatabaseReference vc = _firebase.getReference("vc");
	private ChildEventListener _vc_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_vc_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				vc.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						recyclerview1.setLayoutManager(new LinearLayoutManager(VoteActivity.this));
		...
		vc.addChildEventListener(_vc_child_listener);
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			View _v = _inflater.inflate(R.layout.vicep, null);
			...
			radiobutton1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					if (radiobutton1.isChecked()) {
						...
						vc.child(postlist.get((int)(_position))).updateChildren(map);
					...
					vc.child(postlist.get((int)(_position))).updateChildren(map);
					i.setClass(getApplicationContext(), Vote1Activity.class);
					startActivity(i);
					finish();
				}
			});
